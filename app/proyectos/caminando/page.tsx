      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        ...
        <div className="mt-14 flex flex-col gap-4 rounded-2xl border border-line bg-surface p-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            ...
            className="whitespace-nowrap rounded-full bg-navy px-7 py-3.5 text-center font-body text-sm font-semibold text-cream transition-transform hover:-translate-y-px"
          >
