 ...
 */
const CHAPTER_TONES = [
  { bg: "bg-burgundy", border: "border-burgundy", text: "text-white", route: "text-white/15", tag: "bg-white text-ink" },
  ...
  { bg: "bg-tangerine/16", border: "border-tangerine", text: "text-ink", route: "text-ink/15", tag: "bg-white text-ink" },
] as const;
